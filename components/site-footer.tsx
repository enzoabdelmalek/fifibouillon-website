...
export function SiteFooter() {
  ...
  return (
    <footer className="grain relative overflow-hidden bg-[#6b0b0c] text-[#fff8ca]">
      <div className="relative mx-auto max-w-6xl px-5 py-16 sm:px-8 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-6 max-w-xs text-sm/relaxed text-[#fff8ca]/70">
            ...
            <div className="mt-6 flex gap-3">
              {site.social.instagram ? (
                <a
                  ...
                  className="grid size-10 place-items-center rounded-full border border-[#fff8ca]/25 transition-colors hover:bg-[#fff8ca]/10"
                >
          ...
          <div>
            <h2 className="eyebrow text-[#c8920e]">Le restaurant</h2>
            <ul className="mt-5 space-y-2.5 text-sm">
              {nav.slice(1).map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-[#fff8ca]/75 transition-colors hover:text-[#fff8ca]"
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          <div>
            <h2 className="eyebrow text-[#c8920e]">Nous trouver</h2>
            <address className="mt-5 space-y-4 text-sm/relaxed not-italic text-[#fff8ca]/75">
              <p>
                {site.address.street}
                <br />
              ...
              <p>
                <a
                  ...
                  className="block transition-colors hover:text-[#fff8ca]"
                >
            ...
            <h2 className="eyebrow mt-8 text-[#c8920e]">Horaires</h2>
            <dl className="mt-5 space-y-2 text-sm text-[#fff8ca]/75">
              {site.hours.map((slot) => (
        ...
        <div className="mt-14 flex flex-col gap-4 border-t border-[#fff8ca]/15 pt-7 text-xs text-[#fff8ca]/55 sm:flex-row sm:items-center sm:justify-between">
          <p>
